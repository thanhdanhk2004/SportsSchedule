...
namespace SportSchedule.Migrations
{
    ...
    [Migration("20250804085544_alter relationship extend")]
    partial class alterrelationshipextend
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportSchedule.Model.CommentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2025, 8, 4, 8, 55, 43, 429, DateTimeKind.Utc).AddTicks(5742));
            ...
            modelBuilder.Entity("SportSchedule.Model.GuessModel", b =>
                {
                    ...
                    b.Property<DateTime?>("GuessTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 4, 8, 55, 43, 461, DateTimeKind.Utc).AddTicks(4477));
            ...
            modelBuilder.Entity("SportSchedule.Model.MessageModel", b =>
                {
                    ...
                    b.Property<DateTime?>("SendTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 4, 8, 55, 43, 431, DateTimeKind.Utc).AddTicks(7432));
            ...
            modelBuilder.Entity("SportSchedule.Model.PostModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 4, 8, 55, 43, 422, DateTimeKind.Utc).AddTicks(3542));
