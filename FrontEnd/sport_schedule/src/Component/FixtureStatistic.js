            ...
            <Container className="mt-4 p-3 border rounded shadow-sm" style={{ width: "600px" }}>
                ...
                <Table bordered hover >
                    <tbody>
                        ...
                        <tr className="text-center">
                            <td>{statisticTeamHome.shortOnGoal ? statisticTeamHome.shortOnGoal : "0"}</td>
                            <td>Cú sút trúng đích</td>
                            <td>{statisticTeamAway.shortOnGoal ? statisticTeamAway.shortOnGoal : "0"}</td>
                        </tr>
                        <tr className="text-center">
                            <td>{statisticTeamHome.corners ? statisticTeamHome.corners : "0"}</td>
                            <td>Số phạt góc</td>
                            <td>{statisticTeamAway.corners ? statisticTeamAway.corners : "0"}</td>
                        </tr>
                        <tr className="text-center">
                            <td>{statisticTeamHome.yellowCards ? statisticTeamHome.yellowCards : "0"}</td>
                            <td>Số thẻ vàng</td>
                            <td>{statisticTeamAway.yellowCards ? statisticTeamAway.yellowCards : "0"}</td>
                        </tr>
                        <tr className="text-center">
                            <td>{statisticTeamHome.redCare ? statisticTeamHome.redCare : "0"}</td>
                            <td className="text-center">Số thẻ đỏ</td>
                            <td>{statisticTeamAway.redCare ? statisticTeamAway.redCare : "0"}</td>
                        </tr>
                    </tbody>
                </Table>
            </Container>
