...
namespace SportSchedule.Migrations
{
    ...
    [Migration("20250823023639_update relatioship")]
    partial class updaterelatioship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportSchedule.Model.AppointmentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("DateSend")
                        ...
                        .HasDefaultValue(new DateTime(2025, 8, 23, 2, 36, 38, 385, DateTimeKind.Utc).AddTicks(3214));
            ...
            modelBuilder.Entity("SportSchedule.Model.CommentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 23, 2, 36, 38, 310, DateTimeKind.Utc).AddTicks(6502));
            ...
            modelBuilder.Entity("SportSchedule.Model.GuessModel", b =>
                {
                    ...
                    b.Property<DateTime?>("GuessTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 23, 2, 36, 38, 365, DateTimeKind.Utc).AddTicks(3757));
            ...
            modelBuilder.Entity("SportSchedule.Model.MessageModel", b =>
                {
                    ...
                    b.Property<DateTime?>("SendTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 23, 2, 36, 38, 314, DateTimeKind.Utc).AddTicks(1632));
            ...
            modelBuilder.Entity("SportSchedule.Model.PostModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 23, 2, 36, 38, 301, DateTimeKind.Utc).AddTicks(4022));
