...
namespace SportSchedule.Migrations
{
    ...
    [Migration("20250803160332_add column number")]
    partial class addcolumnnumber
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportSchedule.Model.CommentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2025, 8, 3, 16, 3, 30, 785, DateTimeKind.Utc).AddTicks(414));
            ...
            modelBuilder.Entity("SportSchedule.Model.GuessModel", b =>
                {
                    ...
                    b.Property<DateTime?>("GuessTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 3, 16, 3, 30, 847, DateTimeKind.Utc).AddTicks(5390));
            ...
            modelBuilder.Entity("SportSchedule.Model.MessageModel", b =>
                {
                    ...
                    b.Property<DateTime?>("SendTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 3, 16, 3, 30, 792, DateTimeKind.Utc).AddTicks(954));
            ...
            modelBuilder.Entity("SportSchedule.Model.PostModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 3, 16, 3, 30, 771, DateTimeKind.Utc).AddTicks(9462));
