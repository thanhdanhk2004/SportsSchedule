...
namespace SportSchedule.Migrations
{
    ...
    [Migration("20250820142421_add attribute predict for Match")]
    partial class addattributepredictforMatch
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportSchedule.Model.CommentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2025, 8, 20, 14, 24, 19, 562, DateTimeKind.Utc).AddTicks(4257));
            ...
            modelBuilder.Entity("SportSchedule.Model.GuessModel", b =>
                {
                    ...
                    b.Property<DateTime?>("GuessTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 20, 14, 24, 19, 612, DateTimeKind.Utc).AddTicks(6465));
            ...
            modelBuilder.Entity("SportSchedule.Model.MessageModel", b =>
                {
                    ...
                    b.Property<DateTime?>("SendTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 20, 14, 24, 19, 564, DateTimeKind.Utc).AddTicks(8416));
            ...
            modelBuilder.Entity("SportSchedule.Model.PostModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 20, 14, 24, 19, 556, DateTimeKind.Utc).AddTicks(617));
