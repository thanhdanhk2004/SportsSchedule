...
namespace SportSchedule.Migrations
{
    ...
    [Migration("20250822155601_update database2")]
            ...
            modelBuilder.Entity("SportSchedule.Model.AppointmentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("DateSend")
                        ...
                        .HasDefaultValue(new DateTime(2025, 8, 22, 15, 55, 58, 396, DateTimeKind.Utc).AddTicks(4317));
            ...
            modelBuilder.Entity("SportSchedule.Model.CommentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 22, 15, 55, 58, 283, DateTimeKind.Utc).AddTicks(6591));
            ...
            modelBuilder.Entity("SportSchedule.Model.GuessModel", b =>
                {
                    ...
                    b.Property<DateTime?>("GuessTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 22, 15, 55, 58, 381, DateTimeKind.Utc).AddTicks(6188));
            ...
            modelBuilder.Entity("SportSchedule.Model.MessageModel", b =>
                {
                    ...
                    b.Property<DateTime?>("SendTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 22, 15, 55, 58, 292, DateTimeKind.Utc).AddTicks(741));
            ...
            modelBuilder.Entity("SportSchedule.Model.PostModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 22, 15, 55, 58, 267, DateTimeKind.Utc).AddTicks(5025));
