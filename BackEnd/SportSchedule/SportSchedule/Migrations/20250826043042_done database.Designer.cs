...
namespace SportSchedule.Migrations
{
    ...
    [Migration("20250826043042_done database")]
            ...
            modelBuilder.Entity("SportSchedule.Model.AppointmentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("DateSend")
                        ...
                        .HasDefaultValue(new DateTime(2025, 8, 26, 4, 30, 41, 384, DateTimeKind.Utc).AddTicks(5280));
            ...
            modelBuilder.Entity("SportSchedule.Model.AwardModel", b =>
                {
                    ...
                    b.Property<DateTime?>("TimeAward")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 26, 4, 30, 41, 375, DateTimeKind.Utc).AddTicks(9702));
            ...
            modelBuilder.Entity("SportSchedule.Model.CommentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 26, 4, 30, 41, 345, DateTimeKind.Utc).AddTicks(3572));
            ...
            modelBuilder.Entity("SportSchedule.Model.GuessModel", b =>
                {
                    ...
                    b.Property<DateTime?>("GuessTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 26, 4, 30, 41, 374, DateTimeKind.Utc).AddTicks(6896));
            ...
            modelBuilder.Entity("SportSchedule.Model.PostModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 26, 4, 30, 41, 339, DateTimeKind.Utc).AddTicks(4148));
