...
namespace SportSchedule.Migrations
{
    ...
    [Migration("20250815084354_add attribute status for Post")]
    partial class addattributestatusforPost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportSchedule.Model.CommentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2025, 8, 15, 8, 43, 53, 550, DateTimeKind.Utc).AddTicks(3973));
            ...
            modelBuilder.Entity("SportSchedule.Model.GuessModel", b =>
                {
                    ...
                    b.Property<DateTime?>("GuessTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 15, 8, 43, 53, 621, DateTimeKind.Utc).AddTicks(2073));
            ...
            modelBuilder.Entity("SportSchedule.Model.MessageModel", b =>
                {
                    ...
                    b.Property<DateTime?>("SendTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 15, 8, 43, 53, 556, DateTimeKind.Utc).AddTicks(5321));
            ...
            modelBuilder.Entity("SportSchedule.Model.PostModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 15, 8, 43, 53, 514, DateTimeKind.Utc).AddTicks(441));
