...
namespace SportSchedule.Migrations
{
    ...
    [Migration("20250728143125_alter attribute status to round")]
    partial class alterattributestatustoround
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportSchedule.Model.CommentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2025, 7, 28, 14, 31, 24, 931, DateTimeKind.Utc).AddTicks(9124));
            ...
            modelBuilder.Entity("SportSchedule.Model.GuessModel", b =>
                {
                    ...
                    b.Property<DateTime?>("GuessTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 7, 28, 14, 31, 24, 977, DateTimeKind.Utc).AddTicks(2871));
            ...
            modelBuilder.Entity("SportSchedule.Model.MatchModel", b =>
                {
                    ...
                    b.Property<string>("Time")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("07/28/2025 14:31:24");
            ...
            modelBuilder.Entity("SportSchedule.Model.MessageModel", b =>
                {
                    ...
                    b.Property<DateTime?>("SendTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 7, 28, 14, 31, 24, 936, DateTimeKind.Utc).AddTicks(2122));
            ...
            modelBuilder.Entity("SportSchedule.Model.PostModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 7, 28, 14, 31, 24, 922, DateTimeKind.Utc).AddTicks(6637));
