...
namespace SportSchedule.Migrations
{
    ...
    [Migration("20250822154917_update database")]
            ...
            modelBuilder.Entity("SportSchedule.Model.AppointmentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("DateSend")
                        ...
                        .HasDefaultValue(new DateTime(2025, 8, 22, 15, 49, 14, 179, DateTimeKind.Utc).AddTicks(5611));
            ...
            modelBuilder.Entity("SportSchedule.Model.CommentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 22, 15, 49, 14, 96, DateTimeKind.Utc).AddTicks(289));
            ...
            modelBuilder.Entity("SportSchedule.Model.GuessModel", b =>
                {
                    ...
                    b.Property<DateTime?>("GuessTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 22, 15, 49, 14, 166, DateTimeKind.Utc).AddTicks(8705));
            ...
            modelBuilder.Entity("SportSchedule.Model.MessageModel", b =>
                {
                    ...
                    b.Property<DateTime?>("SendTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 22, 15, 49, 14, 99, DateTimeKind.Utc).AddTicks(1019));
            ...
            modelBuilder.Entity("SportSchedule.Model.PostModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 22, 15, 49, 14, 84, DateTimeKind.Utc).AddTicks(6085));
