...
namespace SportSchedule.Migrations
{
    ...
    [Migration("20250823094319_update attribute table Award")]
    partial class updateattributetableAward
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportSchedule.Model.AppointmentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("DateSend")
                        ...
                        .HasDefaultValue(new DateTime(2025, 8, 23, 9, 43, 17, 565, DateTimeKind.Utc).AddTicks(8004));
            ...
            modelBuilder.Entity("SportSchedule.Model.CommentModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 23, 9, 43, 17, 516, DateTimeKind.Utc).AddTicks(8148));
            ...
            modelBuilder.Entity("SportSchedule.Model.GuessModel", b =>
                {
                    ...
                    b.Property<DateTime?>("GuessTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 23, 9, 43, 17, 551, DateTimeKind.Utc).AddTicks(6564));
            ...
            modelBuilder.Entity("SportSchedule.Model.MessageModel", b =>
                {
                    ...
                    b.Property<DateTime?>("SendTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 23, 9, 43, 17, 518, DateTimeKind.Utc).AddTicks(9901));
            ...
            modelBuilder.Entity("SportSchedule.Model.PostModel", b =>
                {
                    ...
                    b.Property<DateTime?>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 23, 9, 43, 17, 505, DateTimeKind.Utc).AddTicks(1463));
            ...
            modelBuilder.Entity("SportSchedule.Model.SubstitutionModel", b =>
                {
            ...
            modelBuilder.Entity("SportSchedule.Model.PlayerModel", b =>
                {
                    b.HasOne("SportSchedule.Model.MemberModel", "Member")
                        .WithOne("Player")
                        .HasForeignKey("SportSchedule.Model.PlayerModel", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
